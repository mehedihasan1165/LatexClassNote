...
{\huge \calligra{ Notes On Abstract Algebra }\\} % Title
...
\LARGE{Course Name: Abstract Algebra} 
...
{\scshape   \LARGE Prof. Dr. Chandrani Nag\\ } % Editor list
