...
\usepackage{style}
\usepackage{subfiles}
\newcommand{\newtitle}{Discrete Mathematics}
\newcommand{\course}{MAT313}
...
\part{Lecture Note/Sheet}
% chapter begins here
\subfile{./chapters/logic.tex}
\subfile{./chapters/graph.tex}
\subfile{./chapters/boolean.tex}
\subfile{./chapters/finite-state.tex}
\end{document}