...
\newcommand{\newtitle}{Mathematical Modeling in Biology}
\newcommand{\course}{MAT431}
\newcommand{\prof}{Asst. Prof. S. M. Saydur Rahman}
...
\part{Sheet}
\subfile{./chapters/graphical.tex}
\subfile{./chapters/nonlinear.tex}
\subfile{./chapters/pr.tex}
\subfile{./chapters/maltModel.tex}
\subfile{./chapters/sh1.tex}
\subfile{./chapters/someDefn.tex}
\subfile{./chapters/sh3.tex}
\subfile{./chapters/lia.tex}
% \part{Class Note}
% \subfile{./chapters/ch-1.tex}
% \subfile{./chapters/sim.tex}
% \subfile{./chapters/note-NLP.tex}
