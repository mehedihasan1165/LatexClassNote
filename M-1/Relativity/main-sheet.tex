...
\newcommand{\mn}{{\mu\nu}}
\newcommand{\fpar}[3][{}]{\frac{\partial^{#1}\;#2}{\partial\; #3^{#1}}}
\newcommand{\fp}[2]{\frac{\partial\;#1}{\partial\; #2}}
\newcommand{\df}[2]{\frac{\D #1}{\D #2}}
\newcommand{\dnf}[3]{\frac{\D^{#3} #1}{\D #2^{#3}}}
...
\subfile{./chapters/tt.tex}
\part{Cosmology}
\subfile{./chapters/cosmo.tex}
